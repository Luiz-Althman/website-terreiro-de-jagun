                ...
                <div className="flex flex-col gap-4 ">
                    <div className="flex items-center justify-between mt-5 sm:flex-row flex-col-reverse gap-0 sm:gap-4 ">
                        <p className="sm:w-1/2 w-full sm:py-0 py-5 text-[var(--white)] ">
                            ...
                            biológica, não sendo possível explicá-la, mas apenas
                            senti-la. A foto em tela representa alguns dizeres
                            no tratamento dispensado ao Babalorixá Roberto Xáxa,
                            por sua Iyálorixá. São momentos como este,
                            eternizados através de uma fotografia que ficam para
                            a posteridade, bem como, na memoria
                            de quem os viveu.
                        </p>
                        <Image
                    ...
                    <div className="flex items-center justify-between sm:flex-row flex-col gap-0 sm:gap-4">
                        ...
                        <p className="w-1/2 sm:text-left sm:w-1/2 w-full sm:py-0 py-5 text-[var(--white)]">
                            ...
                            dedicação e presteza de todos os filhos da Casa de
                            Candomblé, não havendo distinção entre esta ou
                            aquela festividade, sendo todas objeto de apreço, fé
                            e irmandade de todos os integrantes da comunidade
                            religiosa. Esse tipo de comportamento deveria ser o
                            principio basilar, de todas as Casas de Axé.
                        </p>
                    </div>
                    <div className="flex items-center justify-between pb-5 sm:flex-row flex-col-reverse gap-0 sm:gap-4">
                        <p className=" w-full sm:py-0 py-5 text-[var(--white)]">
                            ...
                            refúgio, o acolhimento, ou seja, um ambiente onde
                            nos sintamos bem. A Religião tem o propósito de nos
                            religar com o sagrado, e não nos afastar. O convívio
                            dentro do espaço litúrgico, necessita ser harmônico,
                            e para tanto, é necessário que se respeitem. Devemos
                            ter zelo pelo Terreiro, como se fosse nossa própria
                            casa. No Terreiro não há espaço para vaidades e
                            egocentrismo, pois as divindades que cultuamos,
                            andam e dançam descalças entre nós, demonstrando
                            toda a sua essência. Se um espaço assim, não lhe
                            apetece, nem adentre.
                        </p>
                        <img
                            src={Terreiro_1.src}
